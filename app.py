...
run_button = st.sidebar.button("Simülasyonu Çalıştır", type="primary")
...
if st.session_state.df_results is not None:
    ...
    st.info("Lütfen sol taraftaki menüden parametreleri ayarlayın ve 'Simülasyonu Çalıştır' butonuna basın.")
